...
OpenCode agents use Markdown files with YAML frontmatter. See `technical-documentation-processor.md` as the reference implementation.
...
Claude Code agents follow a similar Markdown + YAML structure:
...
2. "When invoked" section with numbered objectives
3. "Process" section with bullet-point guidelines
4. "Provide" section listing deliverables
